...
public class Ques722dtest
{
    ...
    private static int[][] accessibility = new int[8][8]; // accessibility array
    ...
    private static ArrayList<Integer> check1;
    private static ArrayList<Integer> checkcopy; // arraylist copy(check) when testing equal feasible values
    private static ArrayList<Integer> check1copy; // arraylist copy when(check1) testing equal feasible valu
    ...
    {
        checkcopy = new ArrayList<Integer>(); // copy initial check arraylist so as to work with a copy instead of altering original array
        check1copy = new ArrayList<Integer>(); // copy initial check1 arraylist so as to work with a copy instead of altering original array
